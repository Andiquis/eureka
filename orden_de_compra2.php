...
<head>
    ...
    <style>
        ...
        th, td { padding: 12px; text-align: left; border: 1px solid black; } /* Borde en celdas */
        th { background-color: #007BFF; color: white; border: 1px solid #ddd; } /* Borde en encabezado */

        /* Colores de estado */
        tr.estado-0 td { background-color: #d4edda; color: black; } /* Comprado */
        tr.estado-1 td { background-color: #fff3cd; color: black; } /* Falta */
        tr.estado-2 td { background-color: #f8d7da; color: black; } /* Sin Stock */
